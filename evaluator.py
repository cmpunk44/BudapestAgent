# evaluator_env_first.py
# Javított tesztelő szkript a Budapest Explorer értékeléséhez
# Ezt a verziót használd, amikor a környezeti változók hibája merül fel
...
os.environ["MAPS_API_KEY"] = "XXXXXXXXXX"
    ...
    def log_result(self, test_id, category, config, query, response_time, 
        ...
        with open(self.filename, 'a', newline='', encoding='utf-8') as f:
            ...
            writer.writerow([
                ...
                result['Notes'], result['Response'][:500]  # Csak az első 500 karakter
            ])
